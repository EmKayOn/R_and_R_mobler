                        ...
                        <div className="max-w-2xl mx-auto">
                            <div className="bg-white shadow-md rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div className="px-5 pb-5">
                                    <Link href={`/products/${getSlug(product.name)}`} className="text-gray-900 font-semibold text-xl tracking-tight dark:text-white">
                                        {product.name}
                                    </Link>
                                    <div className="flex items-center mt-2.5 mb-5">
                                        {[...Array(5)].map((_, starIndex) => (
                                            <svg key={starIndex} className="w-5 h-5 text-yellow-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
